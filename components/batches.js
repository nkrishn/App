...
import { bardata, piedata } from './batch-data';
    ...
    return (
        <View style={{flex: 1, flexDirection: 'column' }}>        
          <View style={{flex: 1.8, flexDirection: 'row' }}>
            ...
            <View style={{flex: 1, flexDirection: 'column' }}>
              <Text style={styles.labelStyle}> BATCHES</Text>
              <View style={{flex: 0.25, flexDirection: 'row' }}>
                <Text style={[styles.legend, { backgroundColor: '#2d6386'}]}></Text>
                <Text >Settled</Text>
              </View>
              <View style={{flex: 0.25, flexDirection: 'row' }}>
                <Text style={[styles.legend, { backgroundColor: '#cd5c5c'}]}></Text>
                <Text>Rejected</Text>
              </View>
              <View style={{flex: 0.25, flexDirection: 'row' }}>
          ...
          <Text style={styles.labelStyle}> BATCHES AMOUNT</Text>
